                        ...
                        <div class="col-md-4">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <table class="table">
                                            ...
                                            @endphp
                                            @if($service->discount)
                                                @if($service->discount_type == 'fixed') @endif
                                                    <tr>
                                                        <td>Discount</td>
                            ...
                            <aside>
                                ...
                                <div class="col-md-12 col-sm-6 col-xs-12 bg-dark color-white padding-top-mini"
                                    ...
                                    <a href="{{route('home.service_details',['serice_slug'=>$r_service->slug])}}">
                                        <div class="img-hover">
                                        ...
                                        <div class="info-gallery">
                                            ...
                                            <hr class="separator">
                                            <p>{{$r_service->name}}</p>
                                            <div class="content-btn"><a href="{{route('home.service_details',['serice_slug'=>$r_service->slug])}}"
