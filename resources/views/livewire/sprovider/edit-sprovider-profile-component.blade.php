                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <form class="form-horizontal" wire:submit.prevent="updateProfile">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select type="text" class="form-control" name="service_category_id" wire:model="service_category_id">
                                                ...
                                                <div class="form-group">
                                                    <label for="service_locations" class="control-label col-md-3">Service Locations Zipcode: </label>
                                                    <div class="col-md-9">
